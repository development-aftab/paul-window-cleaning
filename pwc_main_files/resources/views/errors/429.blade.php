...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .security-guard::before{content:'🚦';font-size:8rem;position:absolute;animation:wave 3s ease-in-out infinite;}
...
<body>
    <div class="floating-icons">
        <i class="floating-icon fas fa-tachometer-alt"></i>
        <i class="floating-icon fas fa-ban"></i>
        <i class="floating-icon fas fa-hand-paper"></i>
        <i class="floating-icon fas fa-exclamation-circle"></i>
    </div>
