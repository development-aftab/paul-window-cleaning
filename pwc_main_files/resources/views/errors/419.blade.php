...
<body>
    <div class="floating-icons">
        ...
        <i class="floating-icon fas fa-hourglass-end"></i>
        <i class="floating-icon fas fa-calendar-times"></i>
        <i class="floating-icon fas fa-exclamation-triangle"></i>
    </div>
