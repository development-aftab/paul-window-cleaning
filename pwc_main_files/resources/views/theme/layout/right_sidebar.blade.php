<div class="app-navbar flex-shrink-0 navbar_wrapper">
    <!--begin::Search-->
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('website') }}/assets/media/avatars/300-6.jpg"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('website') }}/assets/media/avatars/300-2.jpg"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('website') }}/assets/media/avatars/300-9.jpg"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('website') }}/assets/media/avatars/300-14.jpg"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('website') }}/assets/media/avatars/300-11.jpg"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('website') }}/assets/media/svg/brand-logos/volicity-9.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('website') }}/assets/media/svg/brand-logos/tvit.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('website') }}/assets/media/svg/misc/infography.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('website') }}/assets/media/svg/brand-logos/leaf.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('website') }}/assets/media/svg/brand-logos/tower.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
        ...
        <div class="app-navbar-item ms-1 ms-md-4">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                ...
                <div class="d-flex flex-column bgi-no-repeat rounded-top"
                    style="background-image:url('{{ asset('website') }}/assets/media/misc/menu-header-bg.jpg')">
                    <!--begin::Title-->
                        ...
                        <div class="d-flex flex-column px-9">
                            ...
                            <div class="text-center px-4">
                                <img class="mw-100 mh-200px" alt="image"
                                    src="{{ asset('website') }}/assets/media/illustrations/sketchy-1/1.png" />
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Wrapper-->
    ...
    @else
        <div class="app-navbar-item">
            <div class="btn btn-icon btn-custom notification_icon" id="notificationBell"
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                data-kt-menu-placement="bottom-end">
                <span class="custom_icon"><i class="fa-solid fa-bell"></i></span>
                <span class="custom_badge notification_count"
                    style="{{ isset($unreadCount) && $unreadCount > 0 ? 'display: flex;' : 'display: none;' }}">
                    {{ $unreadCount ?? 0 }}
                </span>
            </div>

            <div class="menu menu-sub menu-sub-dropdown menu-column notification_wrapper custom_notification"
                data-kt-menu="true" id="kt_menu_notifications">
                <div class="navbar_notification_header">
                    <h2>Notifications</h2>
                </div>
                <div class="bgi-no-repeat rounded-top right_sidebar_notification_ul">
                    <ul class="nav notification_list">
                        @if (isset($notifications) && $notifications->count() > 0)
                            @foreach ($notifications as $notification)
                                <li class="{{ $notification->is_read ? '' : 'unread' }}">
                                    <div class="notification_user_details">
                                        <div class="img_name_user">
                                            <div class="status_time_img">
                                                <img src="{{ asset('website/assets/images/notification_img.png') }}">
                                            </div>
                            ...
                            @endforeach
                        @else
                            <li class="text-center py-3 text-muted">No notifications found</li>
                        @endif
                    </ul>
                </div>
        ...
        <script>
            // Simple notification - hover par read mark karo aur count 0 karo
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (bellIcon) {
                    // Hover par notifications ko read mark karo
                    bellIcon.addEventListener('mouseenter', function() {
                        if (!markedAsRead && counter && counter.textContent > 0) {
                            ...
                            fetch("{{ route('notifications.markRead') }}", {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        // Count ko 0 karo aur hide karo
                                        counter.textContent = '0';
                                        counter.style.display = 'none';
                                        markedAsRead = true;

                                        // Unread class remove karo
                                        document.querySelectorAll('.notification_list li.unread').forEach(
                                            li => {
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        <!--begin::Menu wrapper-->
        <a href="{{ url('profile_settings') }}" class="custom_flex">
            <div class="cursor-pointer symbol symbol-35px profile_image "
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                data-kt-menu-placement="bottom-end">
                @if (!isset(auth()->user()->profile->pic))
                    <img src="{{ asset('website/users/no_avatar.jpg') }}" alt="user" />
                @else
                    <img src="{{ asset('website') }}/{{ auth()->user()->profile->pic }}" alt="user" />
                @endif
            </div>
            <div class="d-flex flex-column custom_user_name">
                <div class="username">
                    <p>{{ Auth::user()->name ?? '' }}</p>
                    {{--                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span> --}}
                </div>
                {{--            <a href="#" class="user_email">{{Auth::user()->email??''}}</a> --}}
            </div>
        </a>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        @if (!isset(auth()->user()->profile->pic))
                            <img alt="Logo" src="{{ asset('website/users/no_avatar.jpg') }}" />
                        @else
                    ...
                    <span class="menu-title position-relative">Language
                        <span
                            ...
                            <img class="w-15px h-15px rounded-1 ms-2"
                                src="{{ asset('website') }}/assets/media/flags/united-states.svg"
                                alt="" /></span></span>
                </a>
                <!--begin::Menu sub-->
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    ...
                    <div class="menu-item px-3">
                        <a href="#!" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('website') }}/assets/media/flags/spain.svg"
                                    alt="" />
                            </span>Spanish</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu-item px-3">
                        <a href="#!" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('website') }}/assets/media/flags/germany.svg"
                                    alt="" />
                            </span>German</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu-item px-3">
                        <a href="#!" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('website') }}/assets/media/flags/japan.svg"
                                    alt="" />
                            </span>Japanese</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu-item px-3">
                        <a href="#!" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('website') }}/assets/media/flags/france.svg"
                                    alt="" />
                            </span>French</a>
                    </div>
                    <!--end::Menu item-->
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-5">
                <a href="{{ url('logout') }}" class="menu-link px-5">Sign
                    Out</a>
            </div>
            <!--end::Menu item-->
        </div>
